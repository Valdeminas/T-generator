...
namespace T_generator.Controllers.Amazon.Data.Intermediate
{
    public class AmazonMarketplacesController : Controller
    {
        ...
        {
            var amazonMarketplace = await _context.AmazonMarketplaces.SingleOrDefaultAsync(m => m.AmazonMarketplaceID == id);
            DeleteAccountMarketplaces(amazonMarketplace);
            DeleteColorTranslations(amazonMarketplace);
        ...
        private void DeleteAccountMarketplaces(AmazonMarketplace productToUpdate)
        {
            _context.AccountMarketplaces.RemoveRange(_context.AccountMarketplaces.Where(i => i.MarketplaceID == productToUpdate.AmazonMarketplaceID));
            _context.SaveChanges();
        }

        private void DeleteColorTranslations(AmazonMarketplace marketplaceToDelete)
        {
            _context.AmazonColorTranslations.RemoveRange(_context.AmazonColorTranslations.Where(i => i.AmazonMarketplaceID == marketplaceToDelete.AmazonMarketplaceID));
            _context.SaveChanges();
        }
    }
}