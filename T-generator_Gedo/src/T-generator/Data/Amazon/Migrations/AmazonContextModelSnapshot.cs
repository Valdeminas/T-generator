...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("T_generator.Models.Amazon.Data.Basic.AmazonTemplate", b =>
                {
                    b.Property<int>("AmazonTemplateID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("OtherImgUrl2");

                    b.Property<int?>("OtherImgUrl3");
                    ...
                    b.HasKey("AmazonTemplateID");

                    b.HasIndex("AmazonMarketplaceID");

                    b.ToTable("AmazonTemplate");
                });
            ...
            modelBuilder.Entity("T_generator.Models.Amazon.Data.Intermediate.AmazonColorTranslation", b =>
                {
                    b.Property<int>("AmazonColorID");
                    ...
                    b.HasKey("AmazonColorID", "AmazonMarketplaceID");

                    b.HasIndex("AmazonMarketplaceID");

                    b.ToTable("AmazonColorTranslation");
                });
            ...
            modelBuilder.Entity("T_generator.Models.Amazon.Data.JoinTables.DesignMarketplaces", b =>
                {
                    b.Property<int>("DesignID");

                    b.Property<int>("MarketplaceID");

                    b.HasKey("DesignID", "MarketplaceID");

                    b.HasIndex("MarketplaceID");

                    b.ToTable("DesignMarketplaces");
                });
            ...
            modelBuilder.Entity("T_generator.Models.Amazon.Data.JoinTables.TemplateTypes", b =>
                {
            ...
            modelBuilder.Entity("T_generator.Models.Amazon.Data.Intermediate.AmazonColorTranslation", b =>
                {
                    b.HasOne("T_generator.Models.Amazon.Data.Basic.AmazonColor", "AmazonColor")
                        .WithMany()
                        .HasForeignKey("AmazonColorID")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("T_generator.Models.Amazon.Data.JoinTables.DesignMarketplaces", b =>
                {
                    b.HasOne("T_generator.Models.Amazon.Data.Basic.AmazonDesign", "Design")
                        .WithMany("DesignMarketplaces")
            ...
            modelBuilder.Entity("T_generator.Models.Amazon.Data.JoinTables.TemplateTypes", b =>
                {
                    b.HasOne("T_generator.Models.Amazon.Data.Basic.AmazonTemplate", "Template")
                        .WithMany("Types")
                        .HasForeignKey("TemplateID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("T_generator.Models.Amazon.Data.Basic.AmazonType", "Type")
                        .WithMany()
